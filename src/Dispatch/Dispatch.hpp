...
class DispatchOperationGroupContainer: public DispatchOperation {
    
    DispatchOperationGroupP _group;
    
public:
    
    DispatchOperationGroupContainer(DispatchOperationGroupP group);

    DispatchOperationState GetState() override;
...
protected:
    ...
    std::map<std::string, DispatchBackgroundQueueP> _backgroundQueuesSpecial;
...
public:
    ...
    DispatchQueueP GetSpecialQueueWithId(const std::string &queueId);
